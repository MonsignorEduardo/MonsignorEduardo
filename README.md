...
Name:        Eduardo
Location:    Spain
Status:      shipping stuff and keeping it spicy
Mood:        to flama
Now playing: compiler warnings on shuffle
Last login:  probably from a terminal
```

### About Me

Welcome to my little corner of the internet: part code cave, part glittery profile shrine, part questionable early-2000s design decision.

I like building useful things, breaking them in interesting ways, and then making them behave again.
...
- chaotic side quests
- tiny automations
- retro internet energy
- making CLIs do the boring bits
